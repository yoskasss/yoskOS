...
KERNEL_SRCS = kernel/kernel.c kernel/images.c kernel/process.c apps/notepad.c apps/uptime.c apps/games/games.c libs/string.c libs/div64.c libs/console.c libs/info.c
